...
\title[AAMAS-2027 Formatting Instructions]{Formatting Instructions for the 26th International Conference on Autonomous Agents and Multiagent Systems}
...
AAMAS-2027. You can use its source file as a template when writing 
your own paper. It is based on the file `\texttt{sigconf.tex}'
...
For your initial manuscript submission, you will be assigned a submission number when you register the abstract 
of your paper on \textit{OpenReview}. Include this number in your 
document using the `\verb|\acmSubmissionID|' command.
Use the `\verb|\submissionType|' command to specify the track you want to 
submit your paper to. Note that you no longer have to explicitly specify the track in 
the subtitle. The command will update both the header and subtitle accordingly.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.75\linewidth]{aamas27-logo-small}
  \caption{The logo of AAMAS 2027}
  \label{fig:logo}
  \Description{Logo of AAMAS 2027 -- The 26th International Conference on Autonomous Agents and Multiagent Systems.}
\end{figure}
...
following description: ``Logo of AAMAS 2027 -- The 26th International Conference on Autonomous Agents and Multiagent Systems.'' For more information on how best to write figure descriptions 

...
- Submission set: `main.pdf` (manuscript, 25 pages: 4 theorems, 1
  proposition, full pseudocode, a running numerical example, 4
  numerical experiments, a discussion/extensions section, 2
  appendices), `cover_letter.md`, `conference_abstract_submission.md`,
  `title_page.md` (convenience copy of title/author/abstract/keywords
  for pasting into submission-system web forms). No separate
  declarations file, since JOCO folds Statements and Declarations into
  the manuscript itself (unlike BATON's Elsevier venue).

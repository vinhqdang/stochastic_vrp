...
\midrule
Exact DP (Theorem~\ref{thm:dp}) & 2.7 & 9.8 & 38.4 & 166.6 & 663.4 \\
FPTAS (Theorem~\ref{thm:fptas}) & 4.9 & 5.1 & 4.6 & 4.4 & 4.8 \\
\bottomrule
\end{tabular}
\end{table}

The exact DP's runtime grows essentially linearly with $p_{\max}$, as
its $O(nP)$ bound predicts, increasing roughly $250$-fold as $p_{\max}$
...
Mean time (ms) & 1.9 & 2.9 & 2.8 & 2.8 & 2.8 & 3.1 \\
\bottomrule
\end{tabular}
\end{table}
...
$\epsilon$, from $0.5$ to $0.01$, produces roughly a $60\%$ increase in

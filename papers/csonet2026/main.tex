...
$w_{\max}$ and $n$ play a comparatively simpler role.
...
Across all three, the fire's own spatial spread is modeled in detail
...
classification from classical scheduling theory
(\citealp{moore1968,lawlermoore1969,lenstra1977}), its algorithmic
toolkit from knapsack approximation and matroid theory
(\citealp{ibarrakim1975,kortevygen2018}), its deadline-ordering
intuition from real-time systems (\citealp{liulayland1973}), and its
motivating application from disaster-response operations research
(\citealp{harris2023,avci2024,alvelos2025}), but the specific problem
--- and every result we prove about it --- is new. Table~\ref{tab:summary}
...
\citep{lenstra1977}. We conjecture the FPTAS of Theorem~\ref{thm:fptas}

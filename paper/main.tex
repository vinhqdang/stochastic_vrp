...
crossing the handoff price at stop 3---six stops before the breach the
...
\caption{\textsc{Baton} on one 19-stop route in Hanoi. Left: onboard
load across 200 simulated days; the highlighted day breaches capacity at
stop 9 if nobody acts. Centre: the decision rule on that day---the
estimated cost of continuing $\widehat C_k(W_k)$ crosses the per-stop
handoff price at stop 3, where the policy hands off. Right: expected
...
placed at real shops. The real retail clustering shortens optimal
